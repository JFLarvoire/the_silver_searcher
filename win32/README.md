...
Open a cmd.exe command window; Go to the_silver_searcher root directory; Then run:
    ...
    win32\NMaker\include\configure.bat
    make.bat
...
NMaker - A Multi OS make system based on Microsoft nmake
--------------------------------------------------------

Home page: https://github.com/JFLarvoire/NMaker

Installed as a git submodule in the win32\NMaker sub-directory.  
Two scripts, located in win32\NMaker\include are used to building the project:
...
configure.bat also installs short proxy scripts, also called configure.bat and make.bat, in all project source directories.  
This avoids having to add the absolute path to win32\NMaker\include in your PATH. This allows using make.bat in any directory,
...
If the project was cloned from GitHub, the following commands can be used to get updates from GitHub master branch:
